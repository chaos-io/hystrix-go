...
[![GoDoc Documentation](http://godoc.org/github.com/chaos-io/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/chaos-io/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/chaos-io/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/chaos-io/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/chaos-io/hystrix-go```
- ```go test ./...```
